...
session_start();
$themeStyleSheet = 'http://localhost:8001/adaptive/css/light_theme.css';
if (!empty($_COOKIE['theme']) && $_COOKIE['theme'] == 'dark') {
    $themeStyleSheet = 'http://localhost:8001/adaptive/css/dark_theme.css';
}
...
<script>
    ...
    if (currentTheme === "dark") {
        STYLESHEET_LINK.href = "http://localhost:8001/adaptive/css/dark_theme.css"
    } else {
        STYLESHEET_LINK.href = "http://localhost:8001/adaptive/css/light_theme.css"
    }
